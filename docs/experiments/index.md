...
| `0825_kimjaehak_007_label_shift_diagnosis` | 완료 | kimjaehak | 후반부 class=1 증가의 구성·라벨·피처 drift 원인 분해 | Type-conditioned XGBoost (진단) | 005의 라벨 기준 변화 정황은 지지하나, PSI 0.25 이상 162건과 모델 점수 동반 상승으로 혼합 drift 확인 |
